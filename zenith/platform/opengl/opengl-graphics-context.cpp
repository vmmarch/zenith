...
namespace zenith
{
    ...
    void OpenGLGraphicsContext::initialize()
    {
        ...
        if(!success)
            __ZENITH_ERROR(__LOAD_GLAD_FAILED__);

        __ZENITH_INFO(__OPENGL_INFO__);
        __ZENITH_INFO(__VENDOR_INFO__, __glGetVendor());
        __ZENITH_INFO(__RENDER_INFO__, __glGetRender());
        __ZENITH_INFO(__VERSION_INFO__, __glGetVersion());
    }
