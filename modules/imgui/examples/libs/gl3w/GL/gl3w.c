...
PFNGLACTIVEShaderPROC gl3wActiveShader;
PFNGLCREATEShaderVPROC gl3wCreateShaderv;
...
static void load_procs(void)
{
	...
	gl3wActiveShader = (PFNGLACTIVEShaderPROC) get_proc("glActiveShader");
	gl3wCreateShaderv = (PFNGLCREATEShaderVPROC) get_proc("glCreateShaderv");
